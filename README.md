...
the Slow Approach to Ford's Exponent"* (Zenodo DOI: **TODO on upload**).
...
Zenodo record (DOI: **TODO**). A release tag will be cut at the version
matching the published note.
